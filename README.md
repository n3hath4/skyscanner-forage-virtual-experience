...
-**Key Achievements:**
  ...
  -Integrated composable UI components (Calendar, Input, Button) following official documentation.

### **Task 2: Create a Microservice** - ⌛ **In Progress**
-**Objective:** Build a Dropwizard microservice to process car rentals and hotel search requests.
-**Key Learnings:** Microservice architecture, HTTP request processing, and data filtering.
